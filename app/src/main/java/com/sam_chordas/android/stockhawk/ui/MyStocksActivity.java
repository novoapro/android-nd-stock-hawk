...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        intent.putExtra(StockDetailsActivity.STOCK_SYMBOL_EXTRA, mCursor.getString(1));
    ...
    public void goOffline() {
        this.netSnackbar = Snackbar.make(mFab, getString(R.string.network_toast), Snackbar.LENGTH_INDEFINITE)
                .setAction(android.R.string.ok, null);

        mFab.setVisibility(View.INVISIBLE);
        this.netSnackbar.show();
    }

    public void goOnline(){
        if(this.netSnackbar != null && this.netSnackbar.isShownOrQueued())
            this.netSnackbar.dismiss();
